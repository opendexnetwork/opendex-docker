...
class SourceManager(src.SourceManager):
    ...
    def ensure(self, version):
        self.ensure_repo("https://github.com/opendexnetwork/opendexd-webui-poc", self.frontend_dir)
        self.ensure_repo("https://github.com/opendexnetwork/opendexd-socketio", self.backend_dir)
        if version == "latest":
